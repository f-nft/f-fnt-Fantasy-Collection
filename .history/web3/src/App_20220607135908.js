					...
					<div className='col'>
						<body className='nftstaker container border-1' style={{ borderRadius: "25px", boxShadow: "1px 1px 15px #ffffff", minWidth: '70%', maxWidth: '500px', minHeight: '700px', maxHeight: "700px" }}>
							<form>
								...
								<div>
									<label style={{ fontWeight: "300", fontSize: "16px" }}>Select NFT Quantity</label>
								</div>
								<ButtonGroup size="lg"
									aria-label="First group"
									name="amount"
									style={{ boxShadow: "1px 1px 5px #000000", fontFamily: 'Black Ops One', fontSize:'25px', marginTop:'5px', marginBottom:'5px' }}
