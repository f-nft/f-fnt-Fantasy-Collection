		...
		return (
			<div className="App nftapp">
				...
				<div className='row'>
					...
					<div className='col'>
						<body className='nftstaker container border-1'style={{ borderRadius: "25px", boxShadow: "1px 1px 15px #ffffff", minWidth: '600px', maxWidth: '100%', minHeight: '700px' , maxHeight: "700px" }}>
