								...
								<div className='row px-3 center' >
									...
									<div className='col container' style={{ minWidth: '385px', maxWidth: '100%', maxHeight: '300px', minHeight: '300px' }}>
										<form className='stakingrewards' style={{ borderRadius: '25px', boxShadow: '1px 1px 15px #ffffff', fontFamily: 'Rambla' }}>
											...
											<Button onClick={earn} style={{ backgroundColor: '#ffffff10', boxShadow: '1px 1px 5px #000000' }} >Earned FOT Rewards</Button>
											...
											<div className='col-12 mt-2'>
												...
												<Button onClick={claim} style={{ backgroundColor: '#ffffff10', boxShadow: '1px 1px 5px #000000' }} className='mb-2'>Claim</Button>
											</div>
										</form>
									</div>
								</div>
