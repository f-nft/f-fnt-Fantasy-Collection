			...
			<div className='App nftapp'>
				...
				<div className='row bt-1 pt-2 pb-1 center'>
					<div className='col bt-1 pt-2 pb-1 center container'>
						<body className='nftstaker container' style={{ borderRadius: '25px', boxShadow: '1px 1px 15px #ffffff', minWidth: '385px', maxWidth: '485px', minHeight: '700px', maxHeight: '700px' }}>
							<form>
