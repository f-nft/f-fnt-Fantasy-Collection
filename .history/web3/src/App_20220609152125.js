		...
		return (
			<div className='App nftapp'>
				...
				<div className='row bt-1 pt-2 pb-1 center'>
					<div className='col bt-1 pt-2 pb-1 center container'>
						<body className='nftstaker' style={{ borderRadius: '25px', boxShadow: '1px 1px 15px #ffffff', minWidth: '385px', maxWidth: '485px', minHeight: '700px', maxHeight: '700px' }}>
							<form>
								...
								<ButtonGroup size='lg'
									...
									name='amount'
									style={{ boxShadow: '1px 3px 8px #000000', fontFamily: 'Black Ops One', fontSize: '25px', marginTop: '5px', marginBottom: '5px', marginInline: '15px' }}
					...
					<div className='col bt-1 pt-2 pb-1 center'>
						<body className='nftstaker  border-1' style={{ borderRadius: '25px', boxShadow: '1px 1px 15px #ffffff', minWidth: '385px', maxWidth: '100%', minHeight: '700px', maxHeight: '700px' }}>
				...
				<div className='row nftportal mt-3'>
					<div className='col mt-4 ml-3'>
						<img src="matic.png" width={'10%'}></img>
					</div>
					<div className='col'>
