...
class App extends Component {
	...
	render() {
		...
		async function connectwallet() {
			...
			var tokenId = await web3.eth.getElementById();
			var _pid = await web3.eth.getElementById();
			account = accounts[0];
			document.getElementById('wallet-address').textContent = account;
			contract = new web3.eth.Contract(ABI, NFTCONTRACT);
			vaultcontract = new web3.eth.Contract(VAULTABI, STAKINGCONTRACT);
			var getstakednfts = await vaultcontract.methods.tokensOfOwner(account, tokenId).call();
			...
			<div className='App nftapp'>
				...
				<div className='row nftportal mt-3'>
					...
					<div className='col mt-3 mr-5'>
						<img src="matic.png" width={'20%'}></img>
					</div>
				</div>
			</div>
		)
