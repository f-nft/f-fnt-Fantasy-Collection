        ...
        <Flex>
            <Flex fontSize='25px', borderRadius='14px', color='#ffffff', fontWeight='300', fontFamily='Black Ops One'>Fantasy NFT Staking Pool Active Rewards</Flex>
                ...
                <div className='header'>
                    <div fontSize='25px', borderRadius='14px', fontWeight='300', fontFamily='Black Ops One', color='white' }}>FOT Token Stake Farms</div>
                    <Table className='Table Table-bordered Table-dark' borderRadius='14px' }} >
                        <Thead className='Thead-light' fontSize='20px' }}>
                            <tr>
