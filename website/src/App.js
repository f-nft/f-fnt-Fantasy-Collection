...
class App extends Component {
  ...
  async componentDidMount() {
    ...
    await axios.get(polygonscanapi +`?module=stats&action=tokensupply&contractaddress=${NFTCONTRACT}&apikey=${polygonscanapikey}`)
      .then((outputa) => {this.setState({ balance: outputa.data });
                  ...
                  .then(
                    ...
                    .send(
                        ...
                        async function (error, transactionHash) {
                          ...
                          window.console = {
                            log: function (str) {var out = document.createElement("div");
    ...
    return (
      <div className="items-center justify-start p-2 text-center">
        <nav className="navbar full-width navbar-expand-md navbar-dark mb-3">
          ...
          {!isWalletConnect?(
          <div className="p-3">
            <input id="connectbtn" type="Button" className="stakegoldeffect2 connectbutton font-blk" onClick={this.connectWallet} style={{fontSize: "20px",border: "0.2px",borderRadius: "15px",boxShadow: "1px 1px 5px #000000",fontFamily: "Rambla"}} defaultValue="Connect Your Wallet"/>
          </div>
          ):(
          <div className="p-3">
