            ...
            <Container fluid>
                <div className="items-center p-2 text-center">
                    <nav className="navbar full-width navbar-expand-md navbar-dark mb-3">
                        ...
                        {!isWalletConnect ? (
                            <div className="p-3">
                                <input id="connectbtn" type="Button" className="stakegoldeffect2 connectbutton font-blk" onClick={this.connectWallet}
                            ...
                            <div className="p-3">
                                <input id="connectbtn" type="Button" className="stakegoldeffect2 connectbutton font-blk" onClick={DisconnectFromWallet}
                        ...
                        <div className="nftminted row p-3 center">
                            ...
                            <div className="col justify-center">
                                ...
                                <div className="row container-fluid center p-2"> <h5>Your Wallet Address</h5>
                                    <div id="wallet-address" style={{ fontSize: "15px", color: "#39FF14", fontFamily: "Ubuntu", textShadow: "1px 1px 3px black" }} > <label for="floatingInput"> Please <input id="connectbtn" type="Button" className="stakedcard" onClick={this.connectWallet} style={{ fontSize: "20px", border: "1px", borderRadius: "15px", boxShadow: "1px 1px 5px #000000", fontFamily: "Rambla", }} value="Connect Wallet" /> </label> </div>
                                </div>
                                <div> <label style={{ fontWeight: "200", fontSize: "20px", textShadow: "1px 1px 2px #000000", }} > Select NFT Quantity </label>
                                </div>
                                ...
                                <div className="row row-style" style={{ color: "#000039", marginTop: "1px", fontFamily: "Rambla", fontSize: "10px", textShadow: "0px 1px 2px #fffff0", }} > <div className="col">
                                    <Button variant="outline-dark" className="Button-style" onClick={metamint} style={{ border: "1px", borderRadius: "79px", boxShadow: "1px 1px 5px #ffffff", }} > <img src="usdt.png" width="19%" alt="usdt-polygon" /> </Button> </div> <div className="col">
