                        ...
                        {apicall.map((nft, i) => {
                            ...
                            if (owner.indexOf(nft.holder) !== -1) {
                                ...
                                return (
                                    <Carousel>
                                        <Carousel.Item>
                                            <Carousel.Caption className="snap-center static card nft-card mt-3 mb-3" style={{ scrollPaddingInline: "auto", textShadow: "1px 1px 2px #000000", minWidth: '200px' }} key={i}>
