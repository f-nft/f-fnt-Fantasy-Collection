...
import { NFTCONTRACT, STAKINGCONTRACT, moralisapikey, moralisapi, nftpng } from '../config';
...
export default function Listnft() {
    ...
    return (
        <div className="snap-proximity snap-x">
            <div className="snap-center ml-3 mr-3" style={{
                fontFamily: 'Black Ops One',
                display: "inline-grid", gridTemplateColumns: "repeat(3, 4fr)", columnGap: "10px", minWidth: '200px'
            }}>
                // eslint-disable-next-line
                {apicall.map((nft, i) => {
